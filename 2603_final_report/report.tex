...
A brief thanks to Anthropic for their powerful GenAI models, though other models were preferred due to cost.
...
With kernel development as the core case study for this project, the ability for LLMs to understand \textit{Essence C} was assessed by tasking an LLM agent with porting a previously-written PoC operating system kernel from \textit{C} to \textit{Essence C}. The original kernel was developed as part of my YouTube tutorial series [todo], and its latest source code is housed in a \href{https://github.com/davidcallanan/os-series}{separate repository here}. The ported kernel is included in main repository for this project.

\section{Benchmarking}

To kill two birds with one stone, benchmarking was performed on the actual kernel ported by the AI agent, instead of creating artificial benchmarks.
